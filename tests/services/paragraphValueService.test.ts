...
import paragraphValueService from '@/api/services/paragraphValueService'
...
const { createParagraphValue, getParagraphValueByID, updateParagraphValue, deleteParagraphValue } =
  paragraphValueService
