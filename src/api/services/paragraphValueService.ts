...
const createParagraphValue = async (data: {
...
const getParagraphValueByID = async (id: string) => {
  try {
...
const updateParagraphValue = async (id: string, data: {
  source_measurement_id: string;
  value: number;
}) => {
  try {
...
const deleteParagraphValue = async (id: string) => {
  try {
